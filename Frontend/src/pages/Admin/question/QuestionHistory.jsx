          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-slate-50/80 border-b border-slate-100">
                <tr>
                  <th className="px-5 py-4 text-left font-bold text-slate-600 text-xs tracking-wider">Date/Time</th>
                  <th className="px-5 py-4 text-left font-bold text-slate-600 text-xs tracking-wider">Action</th>
                  <th className="px-5 py-4 text-left font-bold text-slate-600 text-xs tracking-wider">Entity Name / Snippet</th>
                  <th className="px-5 py-4 text-left font-bold text-slate-600 text-xs tracking-wider">File Origin</th>
                  <th className="px-5 py-4 text-left font-bold text-slate-600 text-xs tracking-wider">Changed By</th>
                  <th className="px-5 py-4 text-left font-bold text-slate-600 text-xs tracking-wider">Details</th>
                </tr>
              </thead>
